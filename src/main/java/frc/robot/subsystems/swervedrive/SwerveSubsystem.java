...
public class SwerveSubsystem extends SubsystemBase
{
  ...
  // private final boolean     visionDriveTest = false; // Set to false to disable vision odometry updates while driving. This is useful for testing without a camera or when you don't want to use vision.
  /**
...
// Since AutoBuilder is configured, we can use it to build pathfinding commands
  ...
  /**
   * AprilTag data containing position and rotation information
   */
  private static class TagData {
      ...
      public TagData(double rightX, double rightY, Rotation2d botAngle) {
          this.RightX = rightX;
          this.RightY = rightY;
